...
# Model catalog
# ---------------------------------------------------------------------------
# Single source of truth for everything model-specific lives in
# cortex_models.py (context window, backend routing, tool support,
# availability) so ksc.py and this proxy can't drift apart.
from cortex_models import (  # noqa: E402
    BACKEND_AGENT, BACKEND_CHAT, MODEL_CATALOG, DEFAULT_MODEL,
    model_entry, tool_result_char_limit, kilo_models_block,
)
...
def print_kilo_models():
    ...
    """
    print(json.dumps(kilo_models_block(), indent=2, ensure_ascii=False))
